...
local function ZRUQ_fake_script() -- Open.LocalScript 
...
coroutine.wrap(ZRUQ_fake_script)()
local function JFMA_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(JFMA_fake_script)()
local function CZYQ_fake_script() -- PCs.LocalScript 
...
coroutine.wrap(CZYQ_fake_script)()
local function HVLM_fake_script() -- Pods.LocalScript 
...
coroutine.wrap(HVLM_fake_script)()
local function AGSRO_fake_script() -- Exits.LocalScript 
...
coroutine.wrap(AGSRO_fake_script)()
local function UTFKN_fake_script() -- Players.LocalScript 
...
coroutine.wrap(UTFKN_fake_script)()
